    ...
    init() {
        ...
        ajax({
            ...
            success: function(res) {
                ...
                //商品主图底部的5张小图控制主图和放大的图片功能，实现每张图都有放大镜功能
            ...
            if (this.res[i].goodsId == this.goods[0].id) { //比较确认本地存储的产品是不是产品库中的产品再渲染
                ...
                str = `<div class="main-c"  index="${this.res[i].goodsId}">
									<div class="main_l">
										...
										<div class="img_b">
											<img class="img2" src="${this.res[i].src}" >
											<img class="img2" src="${this.res[i].src1}" >
											<img class="img2" src="${this.res[i].src2}" >
											<img class="img2" src="${this.res[i].src3}" >
											<img class="img2" src="${this.res[i].src4}" >
										</div>
									</div>
									<div class="main_r">
